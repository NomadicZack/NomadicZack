...
Applied AI Engineer · AI Automation Engineer · AI Solutions Engineer · AI-Enabled Software Engineer

## Stack

| Area | Tools |
|---|---|
| AI / LLM | Claude, OpenAI, Gemini APIs · Ollama and local models · multi-model agent routing · MCP |
| Automation | n8n · Python · PowerShell · GitHub Actions · Docker on WSL |
| Web / mobile | TypeScript · React · Netlify · Swift / SwiftUI (iOS) |
| Data / glue | Notion API · Google Workspace APIs · SQLite · Git and GitHub |

## Currently learning

- Vets Who Code Phase 0 prework (command line, Git, HTML/CSS, JavaScript, portfolio on GitHub Pages)
- GitHub Copilot certification (GH-300)
- Microsoft Applied Skills: AI Agents in Foundry
- Deepening Python, FastAPI, RAG, vector databases, and evaluation for production agent systems
